...
from metagame_balance.hearthstone.datatypes.Objects import Hs
...
class GamePlayRecorder:
    ...
    def __init__(self, buffer_size: int = 2048, name: str = "", c0: str = "", c1: str = "", t0: List[Hs] = None,
                 t1: List[Hs] = None):
        # Data to record
        self.competitors: List[str] = [c0, c1]
        self.teams: List[List[Hs]] = [t0, t1]
    ...
    def init(self, name: str = None, append=False):
        ...
        with open(self.name, "a+" if append else "w+") as f:
            ...
            for team in self.teams:
                for hs in team:
                    f.write(codecs.encode(pickle.dumps(hs), "hex").decode() + '\n')
                f.write('\n')
