...
from metagame_balance.hearthstone.competition import CompetitorManager, legal_team
from metagame_balance.hearthstone.competition.random_competitor import RandomTeamSelectionCompetitor
from metagame_balance.hearthstone.datatypes.Constants import DEFAULT_MATCH_N_BATTLES, DEFAULT_TEAM_SIZE
from metagame_balance.hearthstone.datatypes.Objects import HsRoster, get_hs_roster_view
from metagame_balance.hearthstone.ecosystem.BattleEcosystem import BattleEcosystem, Strategy
from metagame_balance.hearthstone.util.generator.HsTeamGenerators import RandomTeamFromRoster

from tqdm.auto import tqdm

class ChampionshipEcosystem:

    def __init__(self, roster: HsRoster, meta_data: MetaData, debug=False, render=False,
                 n_battles=DEFAULT_MATCH_N_BATTLES, strategy: Strategy = Strategy.RANDOM_PAIRING,
                 team_size: int = DEFAULT_TEAM_SIZE):
        self.meta_data = meta_data
        self.roster = roster
        self.roster_view = get_hs_roster_view(self.roster)
