...
from metagame_balance.hearthstone.competition import BattleMatch
from metagame_balance.hearthstone.competition import Competitor
from metagame_balance.hearthstone.competition.BattleMatch import RandomTeamsBattleMatch
...
class MatchHandler:
    ...
    def __init__(self, gen: Optional[HsTeamGenerator] = None):
...
class MatchHandlerTree:
    ...
    def __init__(self, competitors: List[CompetitorManager], debug: bool = False,
                 meta_data: Optional[MetaData] = None, gen: Optional[HsTeamGenerator] = None):
...
class TreeChampionship(Championship):
    ...
    def __init__(self, roster: HsRoster, meta_data: Optional[MetaData] = None, debug: bool = False,
                 gen: Optional[HsTeamGenerator] = None):
        self.competitors: List[CompetitorManager] = []
        self.match_tree: Optional[MatchHandlerTree] = None
        self.roster_view = get_hs_roster_view(roster)
        self.meta_data = meta_data
        self.debug = debug
        self.gen = gen
