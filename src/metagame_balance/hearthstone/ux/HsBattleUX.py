...
from metagame_balance.hearthstone.datatypes.Types import HsType, HsStat
# Set constants for the screen size
from metagame_balance.hearthstone.util.Networking import non_blocking_lock
...
class AttackEvent(AnimationEvent):
    ...
    def __init__(self, sprite_hs, sprite_attack, delta):
        self.sprite = sprite_attack
        self.origin = sprite_attack.center_x, sprite_attack.center_y
        self.target = sprite_hs.center_x, sprite_hs.center_y
        self.delta = delta
        self.start_time = 0.0
...
class HsBattleUX(arcade.Window):
    """ Main game class. """
    ...
    def __init__(self, width=SCREEN_WIDTH, height=SCREEN_HEIGHT, title=TITLE):
        ...
        # Set com channel
        self.server = ServerCom(self, authkey='HS AI'.encode('utf-8'))
    ...
    def _init_game(self, data):
        ...
        type0_0 = data[0]
        n = 1
        self.party[0].append(arcade.Sprite(f"sprites/hs/{type0_0}_{n}.png", SPRITE_SCALING))
        ...
        self.party[0].append(arcade.Sprite(f"sprites/hs/{type0_1}_{n}.png", SPRITE_SCALING))
        ...
        self.party[0].append(arcade.Sprite(f"sprites/hs/{type0_2}_{n}.png", SPRITE_SCALING))
        ...
        type1_0 = data[8]
        n = 1
        self.party[1].append(arcade.Sprite(f"sprites/hs/{type1_0}_{n}.png", SPRITE_SCALING))
        ...
        self.party[1].append(arcade.Sprite(f"sprites/hs/{type1_1}_{n}.png", SPRITE_SCALING))
        ...
        self.party[1].append(arcade.Sprite(f"sprites/hs/{type1_2}_{n}.png", SPRITE_SCALING))
    ...
    def _attack(self, data):
        ...
        self.log = f'Trainer {team} attacks with move {HsType(move).name}.'
